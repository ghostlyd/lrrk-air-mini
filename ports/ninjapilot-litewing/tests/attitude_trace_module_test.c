...
uint16_t UAVObjGetNumBytes(UAVObjHandle h) { (void)h; return 120; }
...
UAVObjHandle LiteWingAttitudeTraceHandle(void) { return (void *)(uintptr_t)0xC6CEDB44; }
...
int main(void)
{
    ...
    assert(wire[114] == 2 && wire[115] == 1 && wire[108] == 0);
    ...
    for (unsigned i=0; i<1448; ++i) {
        ...
        LiteWingAttitudeTraceRecord(.002f,a,g,c,r,g,a);
    }
    ...
    uint8_t saved[120]; memcpy(saved,wire,sizeof saved);
    LiteWingAttitudeTraceRecord(.5f,a,g,c,r,g,a);
