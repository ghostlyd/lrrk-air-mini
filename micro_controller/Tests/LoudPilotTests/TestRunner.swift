...
struct LoudPilotTests {
    static func main() {
        do {
            ...
            try PhysicalInputActivityTests.testButtonActivityPersistsUntilRelease()
            try PhysicalInputActivityTests.testDialActivityIsRecentButNotLatched()
            try PhysicalInputActivityTests.testJoystickActivityClearsAtNeutral()
